...
declare variable $allCatches := $simpsonsAll//location => distinct-values();

<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(50, 20)">
    {
        let $d := "<person>Moe</person's Tavern"
        ...
        return
        <g id="{$d}">
            <line x1 = '{0}' y1 ='{$ySpacer}'  x2= '{$xSpacer * $countThisCatch}' y2="{$ySpacer}" stroke='{$colors[1]}' stroke-width='5'/>
        </g>
    }
    </g>
</svg>
