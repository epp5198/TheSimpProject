...
declare variable $allCatches := $simpsonsAll//location[contains(., "Springfield")] => distinct-values();
declare variable $distCatches := $allCatches ! normalize-space() ! lower-case(.) ! replace(., "'", '') => distinct-values();
